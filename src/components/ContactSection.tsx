              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button
                  onClick={() => toast("Coming Soon", {
                    description: "Our Facebook page will be available soon!",
                ...
                <button
                  onClick={() => toast("Coming Soon", {
                    description: "Our Twitter page will be available soon!",
                    position: "bottom-center",
                  })}
                  className="bg-gray-100 hover:bg-app-blue hover:text-white transition-colors p-3 rounded-full"
                >
                ...
                <button
                  onClick={() => toast("Coming Soon", {
                    description: "Our Instagram page will be available soon!",
                    position: "bottom-center",
                  })}
                  className="bg-gray-100 hover:bg-app-blue hover:text-white transition-colors p-3 rounded-full"
                >
