    ...
    <footer className="bg-app-dark text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              The perfect app for your everyday needs. Download today and experience
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <button
            onClick={scrollToTop}
            className="mt-4 md:mt-0 bg-app-dark hover:bg-gray-800 text-white p-3 rounded-full transition-colors"
          >
            <ArrowUp size={20} />
          </button>
        </div>
